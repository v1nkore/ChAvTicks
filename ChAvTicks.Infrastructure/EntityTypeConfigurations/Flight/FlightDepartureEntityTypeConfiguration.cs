...
{
	public class FlightDepartureEntityTypeConfiguration : IEntityTypeConfiguration<FlightDepartureEntity>
	{
		public void Configure(EntityTypeBuilder<FlightDepartureEntity> builder)
		{
